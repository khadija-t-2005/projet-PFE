      ...
      <nav className="w-full h-14 md:h-16 sticky top-0 z-50 flex items-center justify-between px-4 md:px-8 border-b border-white/10 backdrop-blur-md bg-white/10">
        ...
        >
          <span className="font-serif text-white text-xl font-bold tracking-wide">
            Agentic AI Travel<span style={{ color: "#A93226" }}>Planner</span>
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-sm font-semibold px-3.5 py-1.5 rounded-full transition-all duration-200"
            style={{
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.border = "1px solid rgba(169,50,38,0.55)";
              e.currentTarget.style.background = "rgba(169,50,38,0.08)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.color = "rgba(169,50,38,0.8)";
              e.currentTarget.style.border = "1px solid rgba(169,50,38,0.25)";
          ...
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{
                ...
                border: "1px solid rgba(169,50,38,0.45)",
              }}
            >
              <span className="text-xs font-bold" style={{ color: "#A93226" }}>
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <span className="text-sm font-bold" style={{ color: "#A93226" }}>
                {(user?.name || "T")[0].toUpperCase()}
              </span>
            </div>
        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-y-auto px-3 py-3 gap-1">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm transition-all text-left mt-1"
            style={{
              color: "rgba(169,50,38,0.85)",
              border: "1px solid rgba(169,50,38,0.2)",
            }}
            onMouseEnter={e => {
              e.currentTarget.style.color = "#A93226";
              e.currentTarget.style.background = "rgba(169,50,38,0.08)";
              e.currentTarget.style.border = "1px solid rgba(169,50,38,0.35)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.color = "rgba(169,50,38,0.85)";
              e.currentTarget.style.background = "transparent";
              e.currentTarget.style.border = "1px solid rgba(169,50,38,0.2)";
            }}
          >
