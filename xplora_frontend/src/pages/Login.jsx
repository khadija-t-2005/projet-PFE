...
const Login = () => {
  ...
  // تعويض الـ Hook بقيمة ثابتة باش نتفاداو الـ Crash
  const bg = { 
    loading: false, 
    bgUrl: "https://images.unsplash.com/photo-1539635278303-d4002c07eae3?q=80&w=2070", 
    photographer: "SmartTrip Morocco" 
  };
