...
const Signup = () => {
  ...
  // نفس الشيء هنا، كنستعملو قيمة ثابتة باش ما تخرجش ليك الشاشة البيضاء
  const bg = { 
    loading: false, 
    bgUrl: "https://images.unsplash.com/photo-1528127269322-539801943592?q=80&w=2070", 
    photographer: "SmartTrip Explore" 
  };
